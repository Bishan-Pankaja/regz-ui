...
class DesignifyComposer
{
    ...
    public function __construct(
        ...
        $this->Theme8 = [
            'name' => config('designify.theme8.name') ?? 'Modone',
            'colorPrimary' => config('designify.theme8.colorPrimary') ?? '#3b82f6',
            'color50' => config('designify.theme8.color50') ?? '#ffffff',
            'color100' => config('designify.theme8.color100') ?? '#f8f9f8',
            'color200' => config('designify.theme8.color200') ?? '#f1f1f1',
            'color300' => config('designify.theme8.color300') ?? '#e8e8e8',
            'color400' => config('designify.theme8.color400') ?? '#c7c7c7',
            'color500' => config('designify.theme8.color500') ?? '#999999',
            'color600' => config('designify.theme8.color600') ?? '#666666',
            'color700' => config('designify.theme8.color700') ?? '#404040',
            'color800' => config('designify.theme8.color800') ?? '#262626',
            'color900' => config('designify.theme8.color900') ?? '#0f0f0f',
        ];
